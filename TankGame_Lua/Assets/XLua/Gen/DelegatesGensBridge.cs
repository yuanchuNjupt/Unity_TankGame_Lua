...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp11(UnityEngine.Collision p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp12(UnityEngine.Collider p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(System.Action<UnityEngine.Collision>))
			{
			    return new System.Action<UnityEngine.Collision>(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Collider>))
			{
			    return new System.Action<UnityEngine.Collider>(__Gen_Delegate_Imp12);
			}
